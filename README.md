...
- ⚠️ People who have the NetFree™️ filter have reported getting an error when running the app. Adding the following line to the `/client/.env` file fixes this issue: `DANGEROUSLY_DISABLE_HOST_CHECK=true`
